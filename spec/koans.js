...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      const findSome = (matchString) => 'xyz'.includes(matchString);
  ...
  describe('takes a position from where to start searching', function() {
    ...
    describe('invalid positions get converted to 0', function() {
      // Why are these passing when I don't use the char from position 0?
...
describe('destructuring objects. ', () => {
  ...
  describe('nested', () => {
    ...
    it('array and object', () => {
      // This one is weird. I guess I don't need the comma inside the brackets?
...
describe('spread with arrays. ', () => {
  ...
  describe('used as function parameter', () => {
    // This one was extra confusing because it wasn't failing to begin with
...
describe('class creation', () => {
  ...
  // Could this description have been something like: 'anonymous class is a function'?
  it('anonymous class', () => {
